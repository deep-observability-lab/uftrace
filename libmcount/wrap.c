...
__visible_default void *dlopen(const char *filename, int flags)
{
	...
	if (unlikely(check_thread_data(mtdp))) {
		mtdp = mcount_prepare();
		if (mtdp == NULL){
			// printf("nullllllllllllllllllllllllllllllllllllll\n"); 
			return ret;
		}
	}
	else {
