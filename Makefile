...
SYMBOLS_SRCS += $(srcdir)/utils/lzma.c
...
DBGINFO_SRCS += $(srcdir)/utils/filter.c $(srcdir)/utils/lzma.c
...
PYTHON_SRCS += $(srcdir)/utils/lzma.c
...
LIBMCOUNT_UTILS_SRCS += $(srcdir)/utils/lzma.c
